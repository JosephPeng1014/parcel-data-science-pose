...
export class Manager {
  ...
  public static resize(): void {
    ...
    // (Manager.app.view.style as any).width = `${enlargedWidth}px`;
    // (Manager.app.view.style as any).height = `${enlargedHeight}px`;
    // (Manager.app.view.style as any).marginLeft = (Manager.app.view
    //   .style as any).marginRight = `${horizontalMargin}px`;
    // (Manager.app.view.style as any).marginTop = (Manager.app.view
